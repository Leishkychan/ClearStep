...
└── docs/
    ...
    ├── BUILD_STORY.md      # How this was built, the team, and every error we hit
...
| File | Contents |
|---|---|
| [`docs/ARCHITECTURE.md`](./docs/ARCHITECTURE.md) | Full system design and request flow diagrams |
| [`docs/RESPONSIBLE_AI.md`](./docs/RESPONSIBLE_AI.md) | Microsoft RAI Standard v2 mapping |
| [`docs/SECURITY.md`](./docs/SECURITY.md) | Security hardening and 14-vector pentest results |
